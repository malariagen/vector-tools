...
workflow phasing {
	...
	scatter (ch in Chrs){
		call OAP.OcAsPhaser {input: Ch=ch, Samples=Samples, vcf=og_vcf, Name=Name, bam_dir=bam_dir, fasta_file=fasta_file, region_size=region_size, overlap_size=overlap_size, File_dir=File_dir, py_dir=py_dir}		
	}
